...
cmd /c "$azcopy /NC:3 /Y /V:$tempDir\SmartHotelWeb1.log /Source:$container/SmartHotelWeb1.zip                    /Dest:$tempDir\SmartHotelWeb1.zip"
cmd /c "$azcopy /NC:3 /Y /V:$tempDir\SmartHotelWeb2.log /Source:$container/SmartHotelWeb2.zip                    /Dest:$tempDir\SmartHotelWeb2.zip"
cmd /c "$azcopy /NC:3 /Y /V:$tempDir\SmartHotelSQL1.log /Source:$container/SmartHotelSQL1.zip                    /Dest:$tempDir\SmartHotelSQL1.zip"
cmd /c "$azcopy /NC:3 /Y /V:$tempDir\UbuntuWAF.log      /Source:$container/UbuntuWAF.zip                         /Dest:$tempDir\UbuntuWAF.zip"
cmd /c "$azcopy /NC:3 /Y /V:$tempDir\AzureMigrate.log   /Source:$container/AzureMigrateAppliance_v1.19.05.10.zip /Dest:$tempDir\AzureMigrate.zip"
