...
echo    "echo \"Connected to MYSQL Server successfully!\";"  | tee -a /var/www/html/demoapp.php
...
echo     \{  | tee -a /var/www/html/demoapp.php
echo     "echo \"Connection to MY SQL failed: \" . \$e->getMessage();"  | tee -a /var/www/html/demoapp.php
echo     \}  | tee -a /var/www/html/demoapp.php
echo \?\>  | tee -a /var/www/html/demoapp.php
