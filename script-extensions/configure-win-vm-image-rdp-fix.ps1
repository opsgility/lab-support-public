...
if([string]::IsNullOrEmpty($sourceFileUrl) -eq $false -and [string]::IsNullOrEmpty($destinationFolder) -eq $false)
{
    ...
    # Download RDP fix too 
    (New-Object Net.WebClient).DownloadFile("https://opsgilitylabs.blob.core.windows.net/rdp-fix/Windows6.0-KB934307-x86.msu",$destinationPath);
...
& wusa.exe C:\OpsgilityTraining\Windows6.0-KB934307-x86.msu /quiet /forcerestart

# Start-Process -FilePath "wusa.exe C:\OpsgilityTraining\windows10.0-kb4093120-x64_72c7d6ce20eb42c0df760cd13a917bbc1e57c0b7.msu"/quiet /forcerestart" -Verb RunAs -Wait