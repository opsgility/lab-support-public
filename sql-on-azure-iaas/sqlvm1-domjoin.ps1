...
### Setup fileshare for Availability Group
New-Item -Path "C:\AG" -ItemType Directory
New-SmbShare -Name "AG" -Path C:\AG -FullAccess Administrators -ReadAccess Everyone
